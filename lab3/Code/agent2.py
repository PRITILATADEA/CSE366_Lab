...
class Agent2(pygame.sprite.Sprite): #Pygame provides a built-in Sprite class in the pygame.sprite module. When you subclass Sprite, you can define custom behavior for your game objects.
    ...
    def move(self):
        ...
        if self.path:
            ...
            #Multiplies the agent's grid coordinates (self.position[0] and self.position[1]) by the grid_size to get its pixel coordinates.
